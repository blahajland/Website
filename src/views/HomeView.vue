<script setup>
import ContentBlock from '@/components/cards/ContentBlock.vue'
  ...
  <div class="HomeView">
    ...
    <BlockGrid>
      ...
      <ContentBlock color="#F0C1B7">
        <p>Join our Discord server and <b>pass the vibe check &gt;:3</b></p>
        <CustomButton>
          <p>Join</p>
        </CustomButton>
      </ContentBlock>
